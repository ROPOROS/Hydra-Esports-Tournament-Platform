(function ($) {
  ...
  /*=============================================
		=         Live Video Active            =
	=============================================*/
  $(".live-video-active").not(".slick-initialized").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: false,
    fade: true,
  ...
  $(".live-streams-active")
    ...
    .slick({
      ...
      arrows: true,
      prevArrow:
        '<button type="button" class="slick-prev"><img src="assets/img/icon/left_arrow.png" alt=""></button>',
      nextArrow:
        '<button type="button" class="slick-next"><img src="assets/img/icon/right_arrow.png" alt=""></button>',
      slidesToShow: 1,
      slidesToScroll: 1,
      responsive: [
        {
  ...
  $(".gallery-active")
    ...
    .slick({
      ...
      slidesToShow: 1,
      prevArrow:
        '<span class="slick-prev"><i class="far fa-arrow-alt-circle-left"></i></span>',
      nextArrow:
        '<span class="slick-next"><i class="far fa-arrow-alt-circle-right"></i></span>',
  ...
  $(".gallery-nav-active").not(".slick-initialized").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
